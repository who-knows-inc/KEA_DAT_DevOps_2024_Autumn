...
```js
console.log('Indexing:', cleanURL.href);
indexWebPage(pageUrl, mainContent);
```
...
Run `crawler.js` for a cople of seconds and go to the Dashboard to see the indexed content.
...
# Warning - Picking a version = Wasting hours on configuring
