...
link:00._Course_Material/02._Slides/10._Databases_ORM_Data_scraping_Web_crawling/02._databases_orm_migration.md[Databases / ORM / Migration]

link:00._Course_Material/02._Slides/10._Databases_ORM_Data_scraping_Web_crawling/03._web_scraping_web_crawling.md[Web Scraping / Web Crawling]

link:00._Course_Material/02._Slides/10._Databases_ORM_Data_scraping_Web_crawling/04._cheerio.md[Cheerio]

link:00._Course_Material/02._Slides/10._Databases_ORM_Data_scraping_Web_crawling/05._beautifulsoup4.md[BeautifulSoup4]

link:00._Course_Material/02._Slides/10._Databases_ORM_Data_scraping_Web_crawling/06._scrapy.md[Scrapy]
a|
